...
class ProfilePage extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Image(
                                image: AssetImage('assets/Screenshot 2024-02-16 144235.png'), // Example image asset
                                width: 75,
                                height: 75,
                              ),
                            ],
                      ...
                      SizedBox(height: 20), // Add spacing between the container and the list
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              _buildListTile(context, 'Points and Rewards', Contribution()),
                              Divider(),
  ...
  child: Column(
    children: [
      ...
      SizedBox(height: 5), // Add spacing between text and CircleAvatar
      CircleAvatar(
        radius: 40,
        backgroundImage: AssetImage('assets/defprofpic.jpeg'), // Example image asset
      ),
    ],
  ),
)
...
class NotificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Text('This is the Notification Page')
    );
  }
}
