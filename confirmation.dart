...
import 'package:junkee/dbhelper.dart'; // Import the DBHelper class
  ...
  Future<void> fetchPickupAddress() async {
    try {
      ...
      if (addresses.isNotEmpty) {
        setState(() {
          Map<String, dynamic> addressData = addresses.first;
          pickupAddress = _formatAddress(addressData); // Ensure the value is not null
        });
      } else {
        print('No pickup address found in the local database.');
      }
    } catch (e) {
